...
function Header({
  ...
  const namePage = (input) => {
    if (input === "personal/tasks") return "Danh sách công việc"
    if (input === "personal/kanban") return "Bảng công việc"
    if (input === "personal/calendar") return "Lịch"
    if (input === "group/list") return "Danh sách nhóm"
    if (input === "group/task") return "Danh sách công việc"
    if (input === "ho-khau") return "Danh sách hộ khẩu"
    if (input === "nhan-khau") return "Danh sách nhân khẩu"
